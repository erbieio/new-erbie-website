  ...
  return (
    <div className="card-list flex flex-col h-100% gap-2vh">
      <div className="card-box py-1vh">
        <div className="color-#D387FF font-size-12px lh-3.1vh text-left px-16px font-bold">
          Block Details # 128088
        </div>
        <div className="px-16px">
          <div className="flex justify-between stake-line">
      ...
      <div className="card-box font-size-12px text-left  py-1vh">
        <div className="color-#D387FF font-size-12px px-16px lh-3.1vh text-left font-bold">
          Reward List
        </div>
        <div className="px-16px">
          ...
          <div className="line"></div>
          <div className="stake-line">
            <span className="link color-blue">Dxdb33...fe3f74bd</span>|
            <span className="link color-blue">Dxdb33...fe3f74bd</span>
          </div>
          <div className="line"></div>
          <div className="stake-line">

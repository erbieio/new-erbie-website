...
export default function ExplorerMenus() {
  ...
  return (
    <div className="explorer-menus">
      {menuList.map((item, i) => (
        <div
          className={`explorer-card h-60px lg:h-12.1vh font-size-12px hover:underline lg:font-size-16px w-25% lg:w-130px cursor-pointer flex items-center justify-center ${

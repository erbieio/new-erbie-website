...
t&&(e||o[P])?(_(t),me()):// Set back in case no motion but prev status has prepare step
_(L)}),[n]),// ============================ Effect ============================
// Reset when motion changed
g.useEffect((function(){(// Cancel appear
W===C&&!u||// Cancel enter
W===R&&!i||// Cancel leave
W===S&&!v)&&_(L)}),[u,i,v]),g.useEffect((function(){return function(){te.current=!1,clearTimeout(re.current)}}),[]);// Trigger `onVisibleChanged`
var Ee=g.useRef(!1);g.useEffect((function(){// [visible & motion not end] => [!visible & motion end] still need trigger onVisibleChanged
I&&(Ee.current=!0),void 0!==I&&W===L&&(// Skip first render is invisible since it's nothing changed
(Ee.current||I)&&(null==D||D(I)),Ee.current=!0)}),[I,W]);// ============================ Styles ============================
var he=X;return le[P]&&pe===j&&(he=s({transition:"none"},he)),[W,pe,he,null!=I?I:n]}(w,o,(function(){try{// Here we're avoiding call for findDOMNode since it's deprecated
...
var K,q=g.useCallback((function(e){O.current=e,E(t,e)}),[t]),U=s(s({},p),{},{visible:o});// ===================== Render =====================
if(l)if(z===L)// Stable children
K=H?l(s({},U),q):!a&&I.current&&m?l(s(s({},U),{},{className:m}),q):u||!a&&!m?l(s(s({},U),{},{style:{display:"none"}}),q):null;else{var W,_;// In motion
D===P?_="prepare":ee(D)?_="active":D===j&&(_="start");var B=G(v,"".concat(z,"-").concat(_));K=l(s(s({},U),{},{className:d(G(v,z),(W={},f(W,B,B&&_),f(W,v,"string"==typeof v),W)),style:F}),q)}// Auto inject ref if child node not have `ref` props
else// No children
K=null;return g.isValidElement(K)&&h(K)&&(K.ref||(K=g.cloneElement(K,{ref:q}))),g.createElement(A,{ref:M},K)}));return t.displayName="CSSMotion",t}(W)),re="add",oe="keep",ie="remove",ae="removed";function ue(e){var n;return n=e&&"object"===u(e)&&"key"in e?e:{key:e},s(s({},n),{},{key:String(n.key)})}function ce(){return(arguments.length>0&&void 0!==arguments[0]?arguments[0]:[]).map(ue)}var se=["component","children","onVisibleChanged","onAllRemoved"],fe=["status"],le=["eventProps","visible","children","motionName","motionAppear","motionEnter","motionLeave","motionLeaveImmediately","motionDeadline","removeOnLeave","leavedClassName","onAppearPrepare","onAppearStart","onAppearActive","onAppearEnd","onEnterStart","onEnterActive","onEnterEnd","onLeaveStart","onLeaveActive","onLeaveEnd"];e("a",
/**
...
return!n||n.status!==ae||e.status!==ie}))}}}]),c}(g.Component);return f(u,"defaultProps",{component:"div"}),u}(W))}}}));
